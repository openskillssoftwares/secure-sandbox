...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, User, Check } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="card-cyber p-8 rounded-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Start your ethical hacking journey today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-2 mt-3">
                  {passwordRequirements.map((req, index) => (
                    <div key={index} className="flex items-center gap-2 text-xs">
                      <Check className={`h-3 w-3 ${req.met ? "text-green-400" : "text-muted-foreground"}`} />
            ...
            {/* Submit */}
            <Button variant="cyber" className="w-full" size="lg" type="submit" disabled={isLoading}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="cyber-outline" className="w-full" type="button" onClick={handleGoogleSignup}>
            ...
            <Button variant="cyber-outline" className="w-full" type="button" onClick={handleGithubSignup}>
