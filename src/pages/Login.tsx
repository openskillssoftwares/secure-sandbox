      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="card-cyber p-8 rounded-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Sign in to continue your hacking journey</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="cyber-outline" className="w-full" type="button" onClick={handleGoogleLogin}>
            ...
            <Button variant="cyber-outline" className="w-full" type="button" onClick={handleGithubLogin}>
