...
:: Phase 1 Quick Start Script (Windows)
...
set /p db_done="Have you applied the database schema? (y/n): "
...
set /p oauth_done="Have you configured OAuth credentials in .env? (y/n): "
